...
/** Zone reference as generated by the backend, e.g. "Z001". */
const zonenId = z.string().trim().min(1).max(16);

const nachsorgePhotoCheckSchema = z
    .object({
        case_id: objectId,
        zonen_id: zonenId.optional().nullable(),
