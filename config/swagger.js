        ...
        schemas: {
            ...
            CaseIntakeFields: {
                ...
                properties: {
                    ...
                    life_smoker: {
                        type: 'string',
                        enum: ['never', 'former', 'daily_light', 'daily_heavy'],
                    },
                    life_cig_per_day: { type: 'integer', minimum: 0, maximum: 60 },
                    life_alcohol: { type: 'string', enum: ['none', 'occasional', 'regular', 'heavy'] },
                    life_activity: { type: 'string', enum: ['low', 'moderate', 'high'] },
                    life_sleep_hours: { type: 'string', enum: ['under_6', '6_7', '7_8', 'over_8'] },
                    ...
                    life_nutrition: { type: 'string', enum: ['poor', 'fair', 'good', 'excellent'] },
                    goal_target: {
                        type: 'string',
